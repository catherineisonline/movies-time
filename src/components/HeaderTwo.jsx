      ...
      <section className="header-actions">
        <section className="search">
          <section className="search-section" ref={ref}>
            ...
            {searchResults.length > 0 ? (
              <button className="search-btn" onClick={() => setQuery("")}>
                <svg
          ...
          {searchResults && searchResults.length > 0 ? (
            <ul className="search-results">
              {searchResults.map((result, index) => (
                <li key={index}>
                  <Link
                    to={targetLink(result)}
                    onClick={() => viewLink(result)}>
                    <FallbackImage
                      alt={result.title}
                      src={
                        result.poster_path
        ...
        <section className="theme-btns">
          <button
            ...
            className={theme === "light" ? "dark-mode-off" : "dark-mode-on"}>
          ...
          <button
            ...
            className={theme === "dark" ? "light-mode-off" : "light-mode-on"}>
